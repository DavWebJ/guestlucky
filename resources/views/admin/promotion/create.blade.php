 ...
 @section('admin.promotion.create')
                <!-- Page Content -->
                <div class="content">
                                    ...
                                    <form action="{{ route('promotion.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="product_id" name="product_id" required>
                                                <option value="" selected style="display: none;">Choisir le produit que tu veux promouvoir</option>
                                        ...
                                        <div class="form-group">
                                            <label for="tiltle">Crée une phrase d'accroche pour ta promotion</label>
                                            <input type="text" class="form-control" id="title" name="title" placeholder="titre de la promotion" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="desc">Décrit ton produit pour donner envie de l'acheter</label>
                                            <textarea class="form-control tiny" id="desc" name="desc" rows="4" required></textarea>
                                        </div>
                                            <div class="form-group">
                                                <label for="end">Choisis la date à laquelle ta promos prendra fin</label>
                                                <input type="text" class="js-flatpickr form-control bg-white js-flatpickr-enabled flatpickr-input active date" id="end" name="end" placeholder="2021/07/20" readonly="readonly">
                                            </div> 
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Créer cette promotion</h3>
                        </div>
                        <div class="block-content block-content-full">
                            <div class="row justify-content-center">
                                <div class="col-md-8 col-lg-8 m-auto">
                                    <div class="form-group row justify-content-center">
                                        <button type="submit" class="btn btn-alt-primary">Créer cette promotion</button>
                                    </div>
                                    </form>
                                </div>
                            </div>
